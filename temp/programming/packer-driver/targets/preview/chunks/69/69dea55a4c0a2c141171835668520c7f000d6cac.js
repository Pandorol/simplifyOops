System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, error, log, native, sys, oops, JSB_MD5, HotOptions, Hot, _crd;

  function _reportPossibleCrUseOfoops(extras) {
    _reporterNs.report("oops", "db://assets/core/Oops", _context.meta, extras);
  }

  function _reportPossibleCrUseOfJSB_MD(extras) {
    _reporterNs.report("JSB_MD5", "db://assets/libs/jsmd5/jsb_md5", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Hot", Hot = class Hot {
        ...
        init(opt) {
          ...
          (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            ...
            this.assetsMgr.setVerifyCallback((path, asset) => {
              ...
              var size = asset.size;
              var resMD5 = (_crd && JSB_MD5 === void 0 ? (_reportPossibleCrUseOfJSB_MD({
                error: Error()
              }), JSB_MD5) : JSB_MD5)(new Uint8Array(native.fileUtils.getDataFromFile(path)));
              ...
              if (resMD5 == asset.md5) {
                ...
                this.options.onShowPrompt((_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
                  error: Error()
                }), oops) : oops).language.getLangByID("update_tips_update_fileverifyfail"));
                console.log('资源完整性验证失败');
                return false;
        ...
        clearHotUpdateStorage() {// native.fileUtils.removeDirectory(this.storagePath);
        } // 检查更新
...
//# sourceMappingURL=69dea55a4c0a2c141171835668520c7f000d6cac.js.map