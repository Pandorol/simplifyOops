  ...
  return {
    ...
    execute: function () {
      ...
      _export("StorageSecuritySimple", StorageSecuritySimple = class StorageSecuritySimple {
        constructor() {
          this.secretkey = null;
          var key = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
          }), oops) : oops).config.game.localDataKey;
          var iv = (_crd && oops === void 0 ? (_reportPossibleCrUseOfoops({
            error: Error()
...
//# sourceMappingURL=7824b6555aa066bb8609a8cace3a4c6608bb8536.js.map