System.register(["__unresolved_0", "cc", "cc/env", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCBoolean, CCFloat, CCInteger, Component, Enum, EventHandler, instantiate, isValid, Layout, Node, NodePool, Prefab, ScrollView, Size, tween, UITransform, Vec3, Widget, DEV, ListItem, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _crd, ccclass, property, disallowMultiple, menu, executionOrder, requireComponent, TemplateType, SlideType, SelectedType, List;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "5a154v5bS9CFJrqHSJ56hAS", "List", undefined);
      ...
      __checkObsolete__(['_decorator', 'CCBoolean', 'CCFloat', 'CCInteger', 'Component', 'Enum', 'EventHandler', 'instantiate', 'isValid', 'Layout', 'Node', 'NodePool', 'Prefab', 'ScrollView', 'Size', 'tween', 'Tween', 'UITransform', 'Vec2', 'Vec3', 'Widget']);
      ...
      _export("default", List = (_dec = disallowMultiple(), _dec2 = menu('List'), _dec3 = requireComponent(ScrollView), _dec4 = executionOrder(-5000), _dec5 = property({
        ...
        constructor() {
          ...
          this.onScrollEnded = void 0;
          this.onScrollToped = void 0;
        }
        ...
        _onScrollEnded() {
          var t = this;
          t._curScrollIsTouch = false; // 获取当前滚动位置和最大滚动位置

          var scrollOffset = t._scrollView.getScrollOffset();

          var maxScrollOffset = t._scrollView.getMaxScrollOffset(); // 判断是否滚动到顶部
...
//# sourceMappingURL=f7a1ee93b4e72bcb3193daf5a89ec9d858bac730.js.map